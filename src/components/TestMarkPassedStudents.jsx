...
const TestMarkPassedStudents = observer(({onClose,  testEvent, students}) => {
  ...
  const confirm = async (e) => {
    ...
    const updatedStudents = students.map(student => ({
      ...
      testId: testEvent.id,
      passed: selectedStudents.includes(student.id) ? false : true,
    }));
...
export default TestMarkPassedStudents;